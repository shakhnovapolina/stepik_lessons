...
class ProductPage(BasePage):
    def should_be_add_to_backet_button(self):
        assert self.is_element_present(*ProductPageLocators.PRODUCT_BUTTON_ADD_TO_BASKET), "Button Add-to-Backet is not presented"
    ...
    def should_be_name_book_in_alert(self):
        assert self.is_element_present(*ProductPageLocators.PRODUCT_ALERT_NAME_BOOK), "Name of book in alert is not presented"

    def should_be_name_book_product_page(self):
        assert self.is_element_present(*ProductPageLocators.PRODUCT_HEADER_NAME_BOOK), "Name of book on the product page is not presented"
